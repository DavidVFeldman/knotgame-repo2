...
/-!
# Kernel checks at length 16, part 8 (round 10, T31)
...
40–40; the conclusions are in `RequestProject.ExpSharpest`.
-/
...
lemma cellsG40_ok : cellsG40.all P = true := by decide +kernel
